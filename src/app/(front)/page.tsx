  ...
  return (
    <>
      ...
      >
        ...
        Step into a world where entertainment has no limits, and your screens come to life with endless exciting stories.
        </p>
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            {siteConfig.name} enhances your movie watching experience with its juicy features!
          </p>
        </div>
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Large Library of Movies</h3>
                <p className="text-sm text-muted-foreground">
                Cinemaxx holds a library of thousands of movies from different genres, languages, and eras.
                </p>
              </div>
            </div>
          </div>
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Cinemaxx Recommends movies and shows just for you.
                </p>
              </div>
            </div>
          </div>
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Cinemaxx supports multiple devices including smart TVs, smartphones, tablets, laptops, and gaming
                  consoles.
                </p>
              </div>
            </div>
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Cinemax offers No Login , No Signup to its users.
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Quality Streaming</h3>
                <p className="text-sm text-muted-foreground">
                  Cinemaxx offers contents in 4K, Ultra HD and
                  HDR.
                </p>
              </div>
            </div>
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Freeeeeee</h3>
                <p className="text-sm text-muted-foreground">
                  Cinemaxx is freeeeeee.
                </p>
              </div>
            </div>
          </div>
