  ...
  return (
    <footer aria-label="Footer" className="w-full">
      <div className="container grid w-full max-w-6xl gap-7 py-10">
        ...
        Created with 🧡 by Cinemaxx. {new Date().getFullYear()} {siteConfig.author}
        </p>
      </div>
      ...
      <div className="container flex h-24 items-center gap-2 px-8">
        ...
        Cinemaxx doesn’t host any files; it simply provides links to third-party services. Any legal concerns should be directed to the file hosts and providers. CineGeek is not responsible for any media files displayed by the video providers.          <a
